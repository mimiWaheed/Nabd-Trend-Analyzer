...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'footer.l13': 'Pricing', 'footer.l14': 'Live dashboard', 'footer.l15': 'Citizen Portal',
      ...
      'app.nav.admin': 'Admin Panel',
      'app.sep1': 'ANALYSIS', 'app.sep2': 'ACCOUNT', 'app.sep3': 'SERVICES',
      ...
      'db.analyzing': 'Analyzing…', 'db.ready': 'Your results are ready',
      'db.clarify.t': 'Maybe you mean one of these?',
      'db.clarify.thinking': 'Reading your query…',
      'db.clarify.anyway': 'Search “{q}” anyway',
      'db.nav.label': 'Navigate to your NABD application',
      ...
      /* citizen portal */
      'app.title.citizen-portal': 'Citizen Portal',
      'app.sub.citizen-portal': 'Submit a complaint or report an incident — your report is sent directly to the relevant facility.',
      'app.nav.citizen-portal': 'Citizen Portal',
      'cp.form.title': 'New Complaint',
      'cp.form.sub': 'SELECT A CATEGORY AND DESCRIBE YOUR ISSUE',
      'cp.cat.power': 'Power Outage',
      'cp.cat.water': 'Water Flooding',
      'cp.cat.fire': 'Fire',
      'cp.cat.incident': 'Incident',
      'cp.cat.complaint': 'Complaint',
      'cp.cat.infrastructure': 'Infrastructure',
      'cp.cat.waste': 'Waste Management',
      'cp.cat.other': 'Other',
      'cp.form.facility': 'Send report to facility',
      'cp.form.from': 'From (sender email)',
      'cp.form.to': 'To (facility email)',
      'cp.form.to.ph': 'facility@example.com',
      'cp.form.subject': 'Subject',
      'cp.form.subject.ph': 'Brief description of the issue',
      'cp.form.body': 'Complaint details',
      'cp.form.body.ph': 'Describe your complaint or incident in detail...',
      'cp.form.reset': 'Reset',
      'cp.form.send': 'Send Report',
      'cp.status.sending': 'Sending report...',
      'cp.status.sent': 'Report sent successfully!',
      'cp.status.failed': 'Failed to send the report. Please try again.',
      'cp.status.err': 'An error occurred. Please try again later.',
      'cp.incidents.title': 'Recent Analyzed Incidents',
      'cp.incidents.sub': 'SUMMARY OF YOUR LATEST ANALYSIS RESULTS',
      'cp.incidents.empty': 'No incident analyses yet. Run an analysis from the dashboard to see results here.',
      'cp.incidents.cat': 'Category',
      'cp.incidents.src': 'Sources',
      'cp.incidents.run': 'Run analysis',
      'cp.toast.cat': 'Please select a category.',
      'cp.toast.to': 'Please enter a facility email.',
      'cp.toast.body': 'Please describe your complaint.',
      'cp.toast.reset': 'Form reset.',

      /* admin panel */
      'admin.title': 'Admin Panel',
      'admin.sub': 'Manage users, roles and platform health.',
      'admin.stat.users': 'Total Users',
      'admin.stat.reports': 'Total Reports',
      'admin.stat.exports': 'Total Exports',
      'admin.stat.rpm': 'Est. Reports/Min',
      'admin.users.t': 'User Management',
      'admin.users.s': 'ALL REGISTERED USERS',
      'admin.th.name': 'Name',
      ...
      'admin.prev': 'Previous',
      'admin.next': 'Next',
      'admin.modal.profile': 'User Profile',
      'admin.pf.name': 'Name',
      'admin.pf.email': 'Email',
      'admin.pf.role': 'Role',
      'admin.pf.joined': 'Joined',
      'admin.pf.analyses': 'Analyses',
      'admin.pf.searches': 'Searches',
      'admin.pf.downloads': 'Downloads',
      'admin.action.view': 'View',
      'admin.action.role': 'Change Role',
      'admin.action.delete': 'Delete User',
      'admin.search.placeholder': 'Search by name or email...',
      'admin.filter.role.all': 'All Roles',
      'admin.filter.role.superadmin': 'Super Admin',
      'admin.filter.role.admin': 'Admin',
      'admin.filter.role.analyst': 'Analyst',
      'admin.filter.date.all': 'All Time',
      'admin.filter.date.today': 'Joined Today',
      'admin.filter.date.week': 'Joined This Week',
      'admin.filter.date.month': 'Joined This Month',
      'admin.empty': 'No users found matching your criteria.',
      'admin.modal.info': 'Account Information',
      'admin.modal.usage': 'Platform Usage',
      ...
      'dash.qa.nav.citizen-portal': 'Citizen Portal',
      'dash.qa.nav.admin': 'Admin Panel',
      ...
      'rep.sched.add': 'Schedule a report',
      'rep.sched.empty': 'No scheduled reports — schedule one to get an email reminder at the exact time you pick.',
      'rep.sched.guide': 'Pick a saved report, choose the exact date and time, and NABD will email you a reminder once — at that moment only. No repeats, no spam.',
      'rep.sched.cq': "What's the report about?",
      'rep.sched.ql': 'Report query',
      'rep.sched.qph': 'e.g. Suez Canal shipping updates',
      'rep.sched.qh': 'Start typing to pick from your saved reports.',
      'rep.sched.ct': 'When should we remind you?',
      'rep.sched.tl': 'Date and time',
      'rep.sched.th': 'One-time only — sent exactly at the moment you set.',
      'rep.sched.cd': 'Where do we send it?',
      'rep.sched.dl': 'Deliver to',
      'rep.sched.dh': 'Your account email — change it anytime from settings.',
      'rep.sched.submit': 'Schedule report',
      'rep.sched.pending': 'Scheduled',
      'rep.sched.sent': 'Sent',
      'rep.sched.noq': 'Write what the report is about first.',
      'rep.sched.past': 'Pick a future date and time.',
      'rep.sched.fail': 'Could not schedule right now — try again.',
      'app.toast.scheduled': 'Report scheduled — we will email you once, at the chosen time.',
      'rep.exp.empty': 'No exports yet — exports you make from a report appear here.',
      'rep.exp.fallback': 'Report export',
      ...
      'prof.sec.title': 'Account & security',
      'prof.sec.email': 'Change email', 'prof.sec.email.s': 'We will send a verification code to your new address.',
      'prof.sec.pass': 'Change password', 'prof.sec.pass.s': 'Use at least 8 characters.',
      'prof.sec.curpass': 'Current password', 'prof.sec.newemail': 'New email',
      'prof.sec.newpass': 'New password', 'prof.sec.conf': 'Confirm new password',
      'prof.sec.ph.pass': 'Current password', 'prof.sec.ph.email': 'New email address',
      'prof.sec.ph.new': 'New password', 'prof.sec.ph.conf': 'Confirm new password',
      'prof.sec.emailBtn': 'Update email', 'prof.sec.passBtn': 'Update password',
      'prof.sec.sendBtn': 'Send code',
      'prof.sec.verifyBtn': 'Verify code',
      'prof.sec.ph.otp': '6-digit code',
      'prof.sec.note.email': 'We sent a verification code to {e}. Enter it to finish.',
      'prof.sec.note.pass': 'We sent a verification code to your email. Enter it with your new password.',
      'prof.sec.err.otp': 'Please enter the 6-digit code.',
      'prof.sec.err.email': 'Please enter your new email address.',
      'prof.sec.pw.len': '8+ characters', 'prof.sec.pw.letter': 'Contains a letter', 'prof.sec.pw.num': 'Contains a number',
      'prof.sec.v.email.ok': 'Looks good.',
      'prof.sec.v.email.bad': 'Enter a valid email like name@example.com.',
      'prof.sec.v.domain': 'Did you mean {d}?',
      'prof.sec.v.conf.ok': 'Passwords match.',
      'prof.sec.v.conf.bad': "Passwords don't match yet.",
      'prof.sec.err.pass': 'Please enter your current password.',
      'prof.sec.err': 'Something went wrong. Please try again.',
      'prof.sec.toast.email': 'Verification code sent to your new email.',
      'prof.sec.toast.pass': 'Password updated successfully.',
      'prof.sec.toast.verified': 'Email verified successfully.',
      'prof.dash.title': 'Your signal pulse', 'prof.dash.live': 'updates with every analysis',
      'prof.dash.top': 'Top researches by signal health',
      'prof.dash.empty': 'Run an analysis on the dashboard to build your signal pulse.',
      'prof.dash.emg': 'Emergency signals',
      'prof.dash.emg.total': 'Alerts detected', 'prof.dash.emg.runs': 'Runs with alerts',
      'prof.dash.emg.none': 'No emergency signals in your recent analyses.',
    ...
    ar: {
      ...
      'footer.l13': 'الأسعار', 'footer.l14': 'لوحة التحليل المباشر', 'footer.l15': 'بوابة المواطنين',
      ...
      'app.sep1': 'التحليل', 'app.sep2': 'الحساب', 'app.sep3': 'الخدمات',
      ...
      'db.analyzing': 'جارٍ التحليل…', 'db.ready': 'نتائجك جاهزة',
      'db.clarify.t': 'ممكن تقصد واحد من دول؟',
      'db.clarify.thinking': 'بقرأ سؤالك…',
      'db.clarify.anyway': 'ابحث عن «{q}» على أي حال',
      'db.nav.label': 'انتقل إلى تطبيق نبض',
      ...
      /* citizen portal */
      'app.title.citizen-portal': 'بوابة المواطنين',
      'app.sub.citizen-portal': 'قدّم شكوى أو أبلغ عن حادث — يُرسل تقريرك مباشرة إلى الجهة المختصة.',
      'app.nav.citizen-portal': 'بوابة المواطنين',
      'cp.form.title': 'شكوى جديدة',
      'cp.form.sub': 'اختر الفئة وصف مشكلتك',
      'cp.cat.power': 'انقطاع كهرباء',
      'cp.cat.water': 'فيضان مياه',
      'cp.cat.fire': 'حريق',
      'cp.cat.incident': 'حادث',
      'cp.cat.complaint': 'شكوى',
      'cp.cat.infrastructure': 'بنية تحتية',
      'cp.cat.waste': 'إدارة نفايات',
      'cp.cat.other': 'أخرى',
      'cp.form.facility': 'إرسال التقرير إلى منشأة',
      'cp.form.from': 'من (بريد المرسل)',
      'cp.form.to': 'إلى (بريد المنشأة)',
      'cp.form.to.ph': 'facility@example.com',
      'cp.form.subject': 'الموضوع',
      'cp.form.subject.ph': 'وصف مختصر للمشكلة',
      'cp.form.body': 'تفاصيل الشكوى',
      'cp.form.body.ph': 'صف شكواك أو الحادث بالتفصيل...',
      'cp.form.reset': 'إعادة تعيين',
      'cp.form.send': 'إرسال التقرير',
      'cp.status.sending': 'جارٍ إرسال التقرير...',
      'cp.status.sent': 'تم إرسال التقرير بنجاح!',
      'cp.status.failed': 'فشل إرسال التقرير. حاول مرة أخرى.',
      'cp.status.err': 'حدث خطأ. حاول مرة أخرى لاحقًا.',
      'cp.incidents.title': 'الحوادث المحلّلة الأخيرة',
      'cp.incidents.sub': 'ملخص أحدث نتائج التحليلات',
      'cp.incidents.empty': 'لا توجد تحليلات حوادث بعد. قم بتشغيل تحليل من لوحة التحكم لرؤية النتائج هنا.',
      'cp.incidents.cat': 'الفئة',
      'cp.incidents.src': 'المصادر',
      'cp.incidents.run': 'تشغيل التحليل',
      'cp.toast.cat': 'الرجاء اختيار فئة.',
      'cp.toast.to': 'الرجاء إدخال بريد المنشأة.',
      'cp.toast.body': 'الرجاء وصف شكواك.',
      'cp.toast.reset': 'تمت إعادة تعيين النموذج.',

      /* admin panel */
      'admin.title': 'لوحة الإدارة',
      'admin.sub': 'إدارة المستخدمين والأدوار وصحة المنصة.',
      'admin.stat.users': 'إجمالي المستخدمين',
      'admin.stat.reports': 'إجمالي التقارير',
      'admin.stat.exports': 'إجمالي التصديرات',
      'admin.stat.rpm': 'التقارير/الدقيقة',
      'admin.users.t': 'إدارة المستخدمين',
      'admin.users.s': 'جميع المستخدمين المسجلين',
      'admin.th.name': 'الاسم',
      ...
      'admin.prev': 'السابق',
      'admin.next': 'التالي',
      'admin.modal.profile': 'ملف المستخدم',
      'admin.pf.name': 'الاسم',
      'admin.pf.email': 'البريد الإلكتروني',
      'admin.pf.role': 'الدور',
      'admin.pf.joined': 'تاريخ الانضمام',
      'admin.pf.analyses': 'التحليلات',
      'admin.pf.searches': 'عمليات البحث',
      'admin.pf.downloads': 'التنزيلات',
      'admin.action.view': 'عرض',
      'admin.action.role': 'تغيير الدور',
      'admin.action.delete': 'حذف المستخدم',
      'admin.search.placeholder': 'البحث بالاسم أو البريد الإلكتروني',
      'admin.filter.role.all': 'جميع الأدوار',
      'admin.filter.role.superadmin': 'مدير عام',
      'admin.filter.role.admin': 'مدير',
      'admin.filter.role.analyst': 'محلل',
      'admin.filter.date.all': 'كل الأوقات',
      'admin.filter.date.today': 'انضم اليوم',
      'admin.filter.date.week': 'انضم هذا الأسبوع',
      'admin.filter.date.month': 'انضم هذا الشهر',
      'admin.empty': 'لم يتم العثور على مستخدمين يطابقون معاييرك.',
      'admin.modal.info': 'معلومات الحساب',
      'admin.modal.usage': 'استخدام المنصة',
      'app.nav.admin': 'لوحة الإدارة',
      ...
      'dash.qa.nav.citizen-portal': 'بوابة المواطنين',
      'dash.qa.nav.admin': 'لوحة الإدارة',
      ...
      'rep.sched.add': 'جدولة تقرير',
      'rep.sched.empty': 'مفيش تقارير مجدولة — جدول واحد واستلم إيميل بالتذكير في الوقت اللي تختاره بالظبط.',
      'rep.sched.guide': 'اختار تقريرك، حدد التاريخ والساعة بالظبط، ونبض هيبعتلك تذكير بإيميل مرة واحدة — في اللحظة دي بس. من غير تكرار ولا إزعاج.',
      'rep.sched.cq': 'التقرير عن إيه؟',
      'rep.sched.ql': 'موضوع التقرير',
      'rep.sched.qph': 'مثال: تحركات قناة السويس',
      'rep.sched.qh': 'ابدأ تكتب وهنقترح عليك من تقاريرك المحفوظة.',
      'rep.sched.ct': 'امتى نذكّرك؟',
      'rep.sched.tl': 'التاريخ والوقت',
      'rep.sched.th': 'مرة واحدة بس — بيتبعت في نفس اللحظة اللي حددتها.',
      'rep.sched.cd': 'نبعته فين؟',
      'rep.sched.dl': 'يوصلك على',
      'rep.sched.dh': 'إيميل حسابك — تقدر تغيّره من الإعدادات في أي وقت.',
      'rep.sched.submit': 'تأكيد الجدولة',
      'rep.sched.pending': 'مجدول',
      'rep.sched.sent': 'تم الإرسال',
      'rep.sched.noq': 'اكتب موضوع التقرير الأول.',
      'rep.sched.past': 'اختار وقت في المستقبل.',
      'rep.sched.fail': 'مش قدرنا نجدول دلوقتي — جرب تاني.',
      'app.toast.scheduled': 'تم جدولة التقرير — هيوصلك إيميل واحد في الوقت المحدد.',
      'rep.exp.empty': 'مفيش صادرات لسه — أي تصدير تعمله من تقرير هيظهر هنا.',
      'rep.exp.fallback': 'تصدير تقرير',
      ...
      'prof.sec.title': 'الحساب والأمان',
      'prof.sec.email': 'تغيير البريد الإلكتروني', 'prof.sec.email.s': 'سنرسل رمز تحقق إلى بريدك الجديد.',
      'prof.sec.pass': 'تغيير كلمة المرور', 'prof.sec.pass.s': 'استخدم 8 أحرف على الأقل.',
      'prof.sec.curpass': 'كلمة المرور الحالية', 'prof.sec.newemail': 'البريد الإلكتروني الجديد',
      'prof.sec.newpass': 'كلمة المرور الجديدة', 'prof.sec.conf': 'تأكيد كلمة المرور الجديدة',
      'prof.sec.ph.pass': 'كلمة المرور الحالية', 'prof.sec.ph.email': 'البريد الإلكتروني الجديد',
      'prof.sec.ph.new': 'كلمة المرور الجديدة', 'prof.sec.ph.conf': 'تأكيد كلمة المرور الجديدة',
      'prof.sec.emailBtn': 'تحديث البريد', 'prof.sec.passBtn': 'تحديث كلمة المرور',
      'prof.sec.sendBtn': 'إرسال الرمز',
      'prof.sec.verifyBtn': 'تأكيد الرمز',
      'prof.sec.ph.otp': 'رمز من 6 أرقام',
      'prof.sec.note.email': 'أرسلنا رمز تحقق إلى {e}. أدخله لإكمال التغيير.',
      'prof.sec.note.pass': 'أرسلنا رمز تحقق إلى بريدك. أدخله مع كلمة المرور الجديدة.',
      'prof.sec.err.otp': 'يرجى إدخال الرمز المكوّن من 6 أرقام.',
      'prof.sec.err.email': 'يرجى إدخال بريدك الإلكتروني الجديد.',
      'prof.sec.pw.len': '8 أحرف أو أكثر', 'prof.sec.pw.letter': 'تحتوي على حرف', 'prof.sec.pw.num': 'تحتوي على رقم',
      'prof.sec.v.email.ok': 'يبدو جيدًا.',
      'prof.sec.v.email.bad': 'أدخل بريدًا صحيحًا مثل name@example.com.',
      'prof.sec.v.domain': 'هل تقصد {d}؟',
      'prof.sec.v.conf.ok': 'كلمتا المرور متطابقتان.',
      'prof.sec.v.conf.bad': 'كلمتا المرور غير متطابقتين بعد.',
      'prof.sec.err.pass': 'يرجى إدخال كلمة المرور الحالية.',
      'prof.sec.err': 'حدث خطأ ما. حاول مرة أخرى.',
      'prof.sec.toast.email': 'تم إرسال رمز التحقق إلى بريدك الجديد.',
      'prof.sec.toast.pass': 'تم تحديث كلمة المرور بنجاح.',
      'prof.sec.toast.verified': 'تم تأكيد البريد الإلكتروني بنجاح.',
      'prof.dash.title': 'نبض إشاراتك', 'prof.dash.live': 'يتحدث مع كل تحليل',
      'prof.dash.top': 'أهم أبحاثك حسب صحة الإشارة',
      'prof.dash.empty': 'شغّل تحليلاً من لوحة التحكم لبناء نبض إشاراتك.',
      'prof.dash.emg': 'إشارات الطوارئ',
      'prof.dash.emg.total': 'تنبيهات مكتشفة', 'prof.dash.emg.runs': 'تحليلات بها تنبيهات',
      'prof.dash.emg.none': 'لا توجد إشارات طوارئ في تحليلاتك الأخيرة.',
  ...
  function historyAdd(entry) {
    const item = {
      ...
      sig: entry && entry.sig != null && isFinite(Number(entry.sig)) ? Math.round(Number(entry.sig)) : null,
      emg: entry && entry.emg != null && isFinite(Number(entry.emg)) ? Number(entry.emg) : null
    };

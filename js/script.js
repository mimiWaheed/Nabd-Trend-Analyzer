...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'auth.err.name.invalid': 'Letters, spaces, hyphens and apostrophes only.',
      'auth.err.phone': 'Use a valid phone number, e.g. +20 100 000 0000.',
    ...
    ar: {
      ...
      'auth.err.name.invalid': 'حروف ومسافات وشرطات فقط.',
      'auth.err.phone': 'أدخل رقم هاتف صحيح، مثال: +20 100 000 0000.',

...
function makePostgresStore(pool) {
  ...
  return {
    async createUser(u) {
      return one(
        `INSERT INTO users (id, first_name, last_name, email, password_hash, email_verified, phone, organization, country, lang)
        ...
        [u.id, u.firstName, u.lastName, u.email, u.passwordHash, u.emailVerified === true, u.phone || null, u.organization || null, u.country || null, u.lang || 'en']
      );
    },
    async findUserByEmail(email) {
      return one(
